...
class TrackerProfiles {
    ...
    private function BodyProfile() {
        var profile = new TrackerProfile(Body, ["speed", "delta_x", "delta_y", "delta_z", "x_width", "y_width", "z_width", "position", "previous", "velocity", "current_overlap", "overlap_y", "overlap_z", "overlap_x", "facing"]);
        profiles.push(profile);
    }
}